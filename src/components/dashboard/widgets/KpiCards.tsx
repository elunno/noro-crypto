    ...
    return (
        <section className="mb-4 grid gap-4 md:grid-cols-4 bg-red-900" >
            ...
            < div className="rounded-xl bg-white p-4 shadow-sm" >
                ...
                <p className="mt-1 text-xs text-slate-500">Total traded volume in USD</p>
            </div >

            {/* Active Cryptocurrencies */}
            < div className="rounded-xl bg-white p-4 shadow-sm" >
                <p className="text-xs font-medium text-slate-500">Active Cryptocurrencies</p>
                <p className="mt-2 text-2xl font-bold">
                    {data.active_cryptocurrencies.toLocaleString()}
                </p>
                <p className="mt-1 text-xs text-slate-500">Currently listed and active</p>
            </div >
